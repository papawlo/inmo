...
<body <?php body_class('bg-white text-white antialiased'); ?>>
    ...
    <section id="para-quem" class="bg-primary-light py-24 relative">
        ...
        <div class="w-auto absolute bottom-0 right-0">
            <img class="inline align-bottom" src="<?php echo get_template_directory_uri() ?>/img/bike.png" alt="" />
            <img class="inline align-bottom" src="<?php echo get_template_directory_uri() ?>/img/trees.png" alt="" />
        </div>
    </section>
