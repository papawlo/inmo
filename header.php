...
<body <?php body_class( 'bg-white text-indigo-900 antialiased' ); ?>>
...
<div id="page" class="min-h-screen flex flex-col">
				...
				<div class="flex justify-between items-center">
					<div>
						...
						<?php } else { ?>
							...
							<p class="text-sm font-light text-yellow-600">
	...
	<div id="content" class="site-content flex-grow">
		...
		<div class="container mx-auto my-12 border-b pb-12">
			<h1 class="font-bold text-lg text-secondary uppercase">Olá, é bom receber você aqui</h1>
