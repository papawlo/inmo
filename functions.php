...
function tailpress_enqueue_scripts()
{
	...
	wp_enqueue_style('wpb-google-fonts', 'https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,400;0,700;1,400&display=swap', false);
...
function tailpress_setup()
{
	...
	function tailpress_custom_logo_setup()
	{
		$defaults = array(
			'height'               => 25,
			'width'                => 81,
	...
	add_action('after_setup_theme', 'tailpress_custom_logo_setup');
